...
context("Spies, Stubs, and Clock", () => {
  ...
  it("cy.spy() retries until withions pass", () => {
    cy.visit("https://example.cypress.io/commands/spies-stubs-clocks");
  ...
  it("matches call arguments using Sinon matchers", () => {
    ...
    // if we want to with the exact values used during the call
    ...
    // shown if the predicate does not pass and withion fails
    ...
    // matchers can be used from BDD withions
    cy.get("@add").should(
